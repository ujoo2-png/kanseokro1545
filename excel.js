...
function exportUnits() {
  ...
  const rows = [['세대명', '건물', '평수', '냉난방기', 'TV', '냉장고', '세탁기', 'TV거실장', '침대', '옷장']]
  list.forEach(u => rows.push([u.name, _buildingName(u.buildingId), u.size || '', u.hasHeating ? 'O' : '', u.hasTv ? 'O' : '', u.hasFridge ? 'O' : '', u.hasWasher ? 'O' : '', u.hasTvStand ? 'O' : '', u.hasBed ? 'O' : '', u.hasCloset ? 'O' : '']))
